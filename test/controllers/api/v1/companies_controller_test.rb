...
class Api::V1::CompaniesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_company" do
    assert_difference("Api::V1::Company.count") do
      post api_v1_companies_url, params: { api_v1_company: { contact: @api_v1_company.contact, description: @api_v1_company.description, name: @api_v1_company.name } }, as: :json
    end
  ...
  test "should update api_v1_company" do
    patch api_v1_company_url(@api_v1_company), params: { api_v1_company: { contact: @api_v1_company.contact, description: @api_v1_company.description, name: @api_v1_company.name } }, as: :json
    assert_response :success
  end
